...
#
# Canonical multi-stage image for RUNE UI (lpasquali/rune-ui).
# The app repo Dockerfile must stay in lockstep with this file; CI builds use
# lpasquali/rune-ci/.github/workflows/container-build.yml (amd64 + arm64 manifest).
